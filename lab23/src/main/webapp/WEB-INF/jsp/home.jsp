...
<div class="container">
    ...
    <div class="row">
        ...
        <form action="/jsp/home/name" method="get" name="findByName">
            <div class="form-group" >
                <input class="form-control" placeholder="Title" id="name" name="name">
            </div>
            <button type="submit" class="btn btn-primary">Find PrintCenter</button>
        </form><br>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:choose>
                                    ...
                                    <c:when test="${personRole == 2}">
                                        <button type="button" class="btn btn-outline-primary" disabled>Order(Lack of
                                            Balance)
                                        </button>
                                    </c:when>
                                    <c:otherwise>
